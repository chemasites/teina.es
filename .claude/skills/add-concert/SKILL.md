---
name: add-concert
description: Add a new concert/event to the Teína website homepage
user-invocable: true
...
1. Read `templates/index.html` to find the existing concert list and JSON-LD events
...
Look at existing events in `templates/index.html` for the exact class names, date format (`DD mon YYYY`), and structure. Each event needs:
